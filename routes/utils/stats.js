...
function pushLicenseAlert(alerts, seen, ctx, label, expiration) {
  ...
  if (!status) return;
  const resolvedLabel = resolveLicenseItemLabel(label, ctx.itemKey) || ctx.moduleLabel || "Licence";
