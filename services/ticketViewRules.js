const TICKET_VIEW_FIELDS = new Set(["title", "description", "type", "category", "status", "priority", "channel", "client_id", "assigned", "assigned_user_id", "requester_contact_id", "requester_user_id", "ticket_number", "tags"]);
