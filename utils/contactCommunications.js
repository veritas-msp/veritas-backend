  ...
  for (const entry of list) {
    ...
    if (!value) {
      if (entry?.type === "telephone") {
        return "Enter the added phone number or remove it.";
      }
      if (entry?.type === "email") {
        return "Enter the added email address or remove it.";
      }
      return "Enter the added communication method or remove it.";
    }
